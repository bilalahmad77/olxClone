...
function MobilePhonesIndex(){
    ...
    return(
        ...
        <h3 className="ml-3">Mobile Phones in Islamabad Capital Territory</h3>      
            <div className="row">
            ...
            <h6 className="card-title ml-3">Filters</h6>
          <hr></hr>
        <div className="card-body">
          <h5 className="card-title ">CATEGORIES</h5>
          <hr/>
         
          <p className="card-subtitle mb-2 text-muted">All Categories</p>
          <p className="card-text mb-3 text-muted">Mobiles</p>
          <p className="card-title mb-3 text-muted ml-2">Tablets(6004)</p>
          <p className="card-title mb-3 text-muted ml-2">Accessories(28160)</p>
          <p className="card-text ml-2"><b>Mobile Phones(163170)</b></p>
          <hr/>
          <h5 className="card-title ">LOCATIONS</h5>
          <p className="card-title mb-3 text-muted">Pakistan</p>
          <p className="card-text ml-2"><b>Islamabad Capital Territory</b></p>
          <p className="card-title mb-3 text-muted ml-3">Islamabad (8823)</p>
          <hr/>

          <h5 className="card-title ">MAKE</h5>
          <p className="card-title mb-3 text-muted ml-2">Samsung (38776)</p>
          <p className="card-title mb-3 text-muted ml-2">Apple (38384)</p>
          <p className="card-title mb-3 text-muted ml-2">Huawei (16406)</p>
          <p className="card-title mb-3 text-muted ml-2">OPPO (15310)</p>
          <p className="card-title mb-3 text-muted ml-2">Vivo (9414)</p>
          <p className="card-title mb-3 ml-2">View all</p>
          <hr/>
...
export default MobilePhonesIndex;
